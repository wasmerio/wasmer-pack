...
input_file: examples/hello-wasi/generated_bindings/JavaScript/package/node_modules/@wasmer/wasi/dist/Library.umd.js
---
/*!
 * @wasmer/wasi
    ...
    */
    ...
    async function init$1(input) {
        if (typeof input === 'undefined') {
            input = new URL('wasmer_wasi_js_bg.wasm', (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('Library.umd.js', document.baseURI).href)));
        }
        const imports = getImports();
